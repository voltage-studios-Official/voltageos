...
function homeScreen () {
    ...
    homeMenu.setMenuStyleProperty(miniMenu.MenuStyleProperty.Columns, scene.screenWidth() / 20)
    homeMenu.setMenuStyleProperty(miniMenu.MenuStyleProperty.Rows, scene.screenHeight() / 20)
    homeMenu.setDimensions(scene.screenWidth(), scene.screenHeight())
    homeMenu.setPosition(0, 0)
}
let homeMenu: miniMenu.MenuSprite = null
